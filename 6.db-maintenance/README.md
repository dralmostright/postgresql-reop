...
As PostgreSQL is an MVCC architecture, because of that delete doesn't delete the rows in physical files, instead it marks them internally. Hence to remove the dead tuples we will need to run vacuum or vacuum full.
